...
local function lockpickFinish(success)
    ...
    if success then
        ...
        local itemInfo = QBCore.Shared.Items["erovago"]
        if math.random(1, 100) < 20 then
            TriggerServerEvent("QBCore:Server:RemoveItem", "erovago", 1)
...
CreateThread(function()
    Wait(500)
    requiredItems = {
        [1] = {name = QBCore.Shared.Items["erovago"]["name"], image = QBCore.Shared.Items["erovago"]["image"]},
    }
    while true do
        inRange = false
